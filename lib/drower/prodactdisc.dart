...
class ProdactDisc extends StatefulWidget {
  const ProdactDisc({
    super.key,
   
    String? id, required this.prodactData,required this.productsData,required this.classesData,
  });
  final Map<String, dynamic>? prodactData;
  ...
  @override
  State<ProdactDisc> createState() => _MyAppState();
}

class _MyAppState extends State<ProdactDisc> {
